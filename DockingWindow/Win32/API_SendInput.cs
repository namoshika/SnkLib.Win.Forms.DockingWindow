...
namespace SunokoLibrary.Win32
{
    public static class API_SendInput
    {
        ...
        public static void SendMessage(IntPtr hWnd, ref System.Windows.Forms.Message msg)
        {
            msg.Result = SendMessage(hWnd, (UInt32)msg.Msg, msg.WParam, msg.LParam);
        }
        ...
        [DllImport("user32.dll")]
        private extern static IntPtr WindowFromPoint(POINT lpPoint);
        [DllImport("user32.dll")]
        ...
        public struct MOUSEINPUT
        {
            ...
            //元はULONG_PTRになっている。だから64bit化の際に変なことに？
